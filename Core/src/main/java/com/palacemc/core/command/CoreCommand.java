 ...
 *
 * Commands must throw exceptions in the event of a failure, and you can handle these exceptions using {@link #handleCommandException(com.palacemc.core.command.CommandException, String[], org.bukkit.command.CommandSender)}.
 *
...
public abstract class CoreCommand implements CommandExecutor, TabCompleter {
    ...
    public final boolean onCommand(CommandSender sender, Command command, String s, String[] args) {
        ...
        catch (com.palacemc.core.command.CommandException ex) {
     ...
     *
     * The goal of this method should always be conveying an error message to a user in a friendly manner. The {@link com.palacemc.core.command.CommandException} can be extended by your {@link Plugin} to provide extended functionality.
     *
    ...
    protected void handleCommand(CPlayer player, String[] args) throws com.palacemc.core.command.CommandException {throw new EmptyHandlerException();}
    protected void handleCommand(ConsoleCommandSender commandSender, String[] args) throws com.palacemc.core.command.CommandException {throw new EmptyHandlerException();}
    protected void handleCommand(BlockCommandSender commandSender, String[] args) throws com.palacemc.core.command.CommandException {throw new EmptyHandlerException();}

    // Handles for all types in the event that no specific handler is overridden above.
    protected void handleCommandUnspecific(CommandSender sender, String[] args) throws com.palacemc.core.command.CommandException {throw new EmptyHandlerException();}
    protected void handlePostSubCommand(CommandSender sender, String[] args) throws com.palacemc.core.command.CommandException {throw new EmptyHandlerException();}
